    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-muted/20 flex items-center justify-center p-4">
      <div className="w-full max-w-2xl">
        <div className="text-center mb-6">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2 tracking-tight">Join Bookora</h1>
          <p className="text-muted-foreground text-base font-light">Create your account to start managing your books</p>
        </div>
