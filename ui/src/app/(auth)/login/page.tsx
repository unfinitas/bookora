import { LoginForm } from '@/features/auth/forms/loginForms'
import Link from 'next/link'
import { ArrowLeft, Calendar, Shield } from 'lucide-react'
import { ThemeToggle } from '@/components/ui/themeToggle'
import { TypewriterHeader } from '@/components/ui/typewriterHeader'
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-lg animate-slide-up">
        <div className="text-center mb-8">
          ...
          <TypewriterHeader />
          <p className="text-muted-foreground text-lg font-light mt-4">Sign in to your Bookora account</p>
        </div>
